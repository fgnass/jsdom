...
core.DOMImplementation = function DOMImplementation(/* Object */ features) {
  this._features = {};
  if (features) {
...
core.Document = function Document(options) {
  ...
  this.implementation = options.implementation || new core.DOMImplementation();
  this._appendHtmlToElement = parser(options.parser)(this);
