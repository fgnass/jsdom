var dom = require("../level3").dom.level3.html;
var mozHTMLParser = HTMLParser(dom);
...
module.exports = function(document) {
  ...
  return function(html, el) {
    ...
    var parser = mozHTMLParser(doc, ctx);
...
function HTMLParser(impl) {
    ...
    */
     ...
     */
    function HTMLParser(doc, fragmentContext, options) {
        /***
        ...
        if (fragmentContext) { // for innerHTML parsing
            ...
            */
            ...
            stack.push(fragmentContext);
            resetInsertionMode();
            for(var e = fragmentContext; e !== null; e = e.parentNode) {
        ...
        function createHTMLElt(name, attrs) {
            ...
            var interfaceName = tagNameToInterfaceName[name] ||
                "HTMLUnknownElement";
            if(!impl[interfaceName]) interfaceName = "HTMLUnknownElement";
            //var elt = new impl[interfaceName](doc, name, null);
            var elt = doc.createElementNS(HTML_NAMESPACE, name);
            if (attrs) {
                for(var i = 0, n = attrs.length; i < n; i++) {
        ...
        function stopParsing() {
            ...
            if (doc.defaultView) {
                //JSDOM HACK doc.defaultView.dispatchEvent(new impl.Event("load",{}));
            }
        ...
        function initial_mode(t, value, arg3, arg4) {
            ...
            case DOCTYPE:
                ...
                //JSDOM HACK doc.appendChild(new impl.DocumentType(name,publicid, systemid));
